...
/**
 * Use a Zend2_Db Rowset as a datatable for assertions with other PHPUnit Database extension tables.
 *
 * @uses       PHPUnit_Extensions_Database_DataSet_AbstractTable
 * @uses       PHPUnit_Extensions_Database_DataSet_DefaultTableMetaData
 * @uses       \Zend2\Db\Table\AbstractRowset
...
{
    /**
     * Construct Table object from a Zend2_Db_Table_Rowset
     *
     * @param \Zend2\Db\Table\AbstractRowset $rowset
     * @param string $tableName
     */
    public function __construct(\Zend2\Db\Table\AbstractRowset $rowset, $tableName = null)
    {
        if($tableName == null) {
