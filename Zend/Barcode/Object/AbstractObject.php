...
namespace Zend2\Barcode\Object;

use Traversable,
    Zend2\Barcode,
    Zend2\Barcode\Object\Exception,
    Zend2\Validator\Barcode as BarcodeValidator,
...
abstract class AbstractObject implements Barcode\Object
{
     ...
     * @var string
     */
    protected $barcodeNamespace = 'Zend2\Barcode\Object';
     ...
     * @param integer $value
     * @return \Zend2\Barcode\Object
     * @throw \Zend2\Barcode\Object\Exception
     */
     ...
     * @param boolean $value
     * @return Zend2\Barcode\AbstractObject
     */
