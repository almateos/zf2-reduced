...
namespace Zend2\Ldap\Node\Schema\AttributeType;

use Zend2\Ldap\Node\Schema,
    Zend2\Ldap\Node\Schema\AttributeType;

/**
 * Zend2\Ldap\Node\Schema\AttributeType\OpenLdap provides access to the attribute type
