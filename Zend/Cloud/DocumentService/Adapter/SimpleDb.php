...
use Zend2\Cloud\DocumentService\Adapter\SimpleDb\Query,
    Zend2\Service\Amazon\Exception as AmazonException,
    Zend2\Service\Amazon\SimpleDb\SimpleDb as SimpleDbService,
    Zend2\Service\Amazon\SimpleDb\Attribute,
...
class SimpleDb extends AbstractAdapter
{
    ...
    const DEFAULT_QUERY_CLASS = 'Zend2\Cloud\DocumentService\Adapter\SimpleDb\Query';


    /**
     * SQS service instance.
     * @var Zend2\Service\Amazon\SimpleDb
     */
    protected $_simpleDb;
     ...
     * @var string
     */
    protected $_queryClass = 'Zend2\Cloud\DocumentService\Adapter\SimpleDb\Query';
    ...
    {
        if ($options instanceof Zend2\Config) {
    ...
    public function createCollection($name, $options = null)
    {
        ...
        } catch(Zend2\Service\Amazon\Exception $e) {
     ...
     *
     * @param  string $collectionName
     * @param  mixed|Zend2\Cloud\DocumentService\Document $documentId Document ID, adapter-dependent
     * @param  array|Zend2\Cloud\DocumentService\Document $fieldset Set of fields to update
     * @param  array $options
     * @return boolean
     */
    ...
    public function query($collectionName, $query, $options = null)
    {
        ...
        try {
            if ($query instanceof Zend2\Cloud\DocumentService\Adapter\SimpleDb\Query) {
     ...
     *
     * @param  string $fields
     * @return Zend2\Cloud\DocumentService\Adapter\SimpleDb\Query
     */
     ...
     *
     * @return Zend2\Service\Amazon\SimpleDb
     */
     ...
     *
     * @param  Zend2\Service\Amazon\SimpleDb\Page $resultSet
     * @param  bool $returnDocs
     * @return Zend2\Cloud\DocumentService\DocumentSet
     */
    protected function _getDocumentSetFromResultSet(Zend2\Service\Amazon\SimpleDb\Page $resultSet, $returnDocs = true)
    {
        $docs = array();
