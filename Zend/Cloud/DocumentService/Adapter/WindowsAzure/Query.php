 ...
 * namespace
 */
namespace Zend2\Cloud\DocumentService\Adapter\WindowsAzure;

use Zend2\Cloud\DocumentService\QueryAdapter,
    Zend2\Service\WindowsAzure\Storage\TableEntityQuery,
...
class Query implements QueryAdapter
{
     ...
     *
     * @var Zend2\Service\WindowsAzure\Storage\TableEntityQuery
     */
     ...
     * Constructor
     *
     * @param  null|Zend2\Service\WindowsAzure\Storage\TableEntityQuery $select Table select object
     * @return void
     */
    public function __construct($select = null)
    {
        if (!$select instanceof Zend2\Service\WindowsAzure\Storage\TableEntityQuery) {
     ...
     *
     * @param  string $select
     * @return Zend2\Cloud\DocumentService\Adapter\WindowsAzure_Query
     */
     ...
     *
     * @param string $from
     * @return Zend2\Cloud\DocumentService\Adapter\WindowsAzure\Query
     */
     ...
     * @return Zend2\Cloud\DocumentService\Adapter\WindowsAzure\Query
     * @throws Zend2\Cloud\OperationNotAvailableException
     */
     ...
     *
     * @return Zend2\Service\WindowsAzure\Storage\TableEntityQuery
     */
