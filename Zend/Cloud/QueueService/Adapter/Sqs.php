...
use Zend2\Service\Amazon\Sqs\Sqs as AmazonSqs,
    Zend2\Cloud\QueueService\Message,
    Zend2\Cloud\QueueService\Exception;
    ...
    public function deleteQueue($queueId, $options = null)
{
     ...
     *
     * @param  string $queueId
     * @param  Zend2\Cloud\QueueService\Message $message
     * @param  array  $options
     * @return void
     */
     ...
     * @return Zend2\Service\Amazon\Sqs
     */
