...
use Zend2\Cloud\QueueService\Exception,
    Zend2\Service\WindowsAzure\Storage\Queue,
    Zend2\Config\Config;
...
class WindowsAzure extends AbstractAdapter
{
    ...
    const DEFAULT_HOST = Zend2\Service\WindowsAzure\Storage::URL_CLOUD_QUEUE;

    /**
     * Storage client
     *
     * @var Zend2\Servic\WindowsAzure\Storage\Queue
     */
    ...
    {
        try {
            if ($queueId instanceof \Zend2\Service\WindowsAzure\Storage\QueueInstance) {
    ...
    public function deleteMessage($queueId, $message, $options = null)
    {
        try {
            ...
            if ($message instanceof \Zend2\Service\WindowsAzure\Storage\QueueMessage) {
     ...
     * @return Zend2\Service\Azure\Storage\Queue
     */
