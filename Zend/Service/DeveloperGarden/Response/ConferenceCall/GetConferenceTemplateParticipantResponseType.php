 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend2_Service_DeveloperGarden_Response_ConferenceCall_GetConferenceTemplateParticipantResponseType
    extends Zend2_Service_DeveloperGarden_Response_BaseType
{
    /**
     * the participant
     *
     * @var Zend2_Service_DeveloperGarden_ConferenceCall_Participant
     */
