 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Zend2_Service_DeveloperGarden_Request_ConferenceCall_GetRunningConferenceRequest
    extends Zend2_Service_DeveloperGarden_Request_AbstractRequest
{
     ...
     *
     * @param string $conferenceId
     * @return Zend2_Service_DeveloperGarden_Request_ConferenceCall_GetRunningConferenceRequest
     */
