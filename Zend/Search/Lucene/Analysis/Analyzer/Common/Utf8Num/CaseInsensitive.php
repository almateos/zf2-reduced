...
namespace Zend2\Search\Lucene\Analysis\Analyzer\Common\Utf8Num;
use Zend2\Search\Lucene\Analysis\Analyzer\Common;
use Zend2\Search\Lucene\Analysis\TokenFilter;


/**
 * @uses       \Zend2\Search\Lucene\Analysis\Analyzer\Common\Utf8Num\Utf8Num
 * @uses       \Zend2\Search\Lucene\Analysis\TokenFilter\LowerCaseUtf8
 * @category   Zend2
 * @package    Zend2_Search_Lucene
 * @subpackage Analysis
 * @copyright  Copyright (c) 2005-2012 Zend2 Technologies USA Inc. (http://www.zend.com)
