...
class Photos extends GData
{
    ...
    /**
     * Create Zend2_Gdata_Photos object
     *
    ...
    {
        $this->registerPackage('Zend2\GData\Photos');
        $this->registerPackage('Zend2\GData\Photos\Extension');
     ...
     * @return \Zend2\GData\Photos\UserFeed
    ...
    public function getUserFeed($userName = null, $location = null)
    {
        ...
        return parent::getFeed($uri, 'Zend2\GData\Photos\UserFeed');
    }
     ...
     * @return \Zend2\GData\Photos\AlbumFeed
     * @throws \Zend2\GData\App\Exception
     * @throws \Zend2\GData\App\HttpException
     */
    public function getAlbumFeed($location = null)
    {
        ...
        return parent::getFeed($uri, 'Zend2\GData\Photos\AlbumFeed');
    }
     ...
     *          be returned instead.
     * @return \Zend2\GData\Photos\PhotoFeed
     * @throws \Zend2\GData\App\Exception
     * @throws \Zend2\GData\App\HttpException
     */
    public function getPhotoFeed($location = null)
    {
        ...
        return parent::getFeed($uri, 'Zend2\GData\Photos\PhotoFeed');
    }
     ...
     * @return \Zend2\GData\Photos\UserEntry
     * @throws \Zend2\GData\App\Exception
     * @throws \Zend2\GData\App\HttpException
     */
    public function getUserEntry($location)
    {
        ...
        return parent::getEntry($uri, '\Zend2\GData\Photos\UserEntry');
    }
     ...
     *
     * @param mixed $location The location for the feed, as a URL or Query.
     * @return \Zend2\GData\Photos\AlbumEntry
     * @throws \Zend2\GData\App\Exception
     * @throws \Zend2\GData\App\HttpException
     */
    public function getAlbumEntry($location)
    {
        ...
        return parent::getEntry($uri, 'Zend2\GData\Photos\AlbumEntry');
    }
     ...
     *
     * @param mixed $location The location for the feed, as a URL or Query.
     * @return \Zend2\GData\Photos\PhotoEntry
     * @throws \Zend2\GData\App\Exception
     * @throws \Zend2\GData\App\HttpException
     */
    public function getPhotoEntry($location)
    {
        ...
        return parent::getEntry($uri, 'Zend2\GData\Photos\PhotoEntry');
    }
     ...
     *
     * @param mixed $location The location for the feed, as a URL or Query.
     * @return \Zend2\GData\Photos\TagEntry
     * @throws \Zend2\GData\App\Exception
     * @throws \Zend2\GData\App\HttpException
     */
    public function getTagEntry($location)
    {
        ...
        return parent::getEntry($uri, 'Zend2\GData\Photos\TagEntry');
    }
     ...
     *
     * @param mixed $location The location for the feed, as a URL or Query.
     * @return \Zend2\GData\Photos\CommentEntry
     * @throws \Zend2\GData\App\Exception
     * @throws \Zend2\GData\App\HttpException
     */
    public function getCommentEntry($location)
    {
        ...
        return parent::getEntry($uri, 'Zend2\GData\Photos\CommentEntry');
    }

    /**
     * Create a new album from a AlbumEntry.
     *
     * @param \Zend2\GData\Photos\AlbumEntry $album The album entry to
     *          insert.
     ...
     * @return \Zend2\GData\Photos\AlbumEntry The inserted album entry as
    ...
    public function insertAlbumEntry($album, $uri = null)
    {
        ...
        $newEntry = $this->insertEntry($album, $uri, 'Zend2\GData\Photos\AlbumEntry');
        return $newEntry;
    }
     ...
     *
     * @param \Zend2\GData\Photos\PhotoEntry $photo The photo to insert.
     ...
     * @return \Zend2\GData\Photos\PhotoEntry The inserted photo entry
    ...
    public function insertPhotoEntry($photo, $uri = null)
    {
        ...
        $newEntry = $this->insertEntry($photo, $uri, 'Zend2\GData\Photos\PhotoEntry');
        return $newEntry;
    }
     ...
     *
     * @param \Zend2\GData\Photos\TagEntry $tag The tag entry to insert.
     ...
     * @return \Zend2\GData\Photos\TagEntry The inserted tag entry as returned
     *          by the server.
     * @throws \Zend2\GData\App\Exception
     * @throws \Zend2\GData\App\HttpException
     */
    public function insertTagEntry($tag, $uri = null)
    {
        ...
        $newEntry = $this->insertEntry($tag, $uri, 'Zend2\GData\Photos\TagEntry');
        return $newEntry;
    }
     ...
     *
     * @param \Zend2\GData\Photos\CommentEntry $comment The comment entry to
     *          insert.
     ...
     * @return \Zend2\GData\Photos\CommentEntry The inserted comment entry
     *          as returned by the server.
     * @throws \Zend2\GData\App\Exception
     * @throws \Zend2\GData\App\HttpException
     */
    public function insertCommentEntry($comment, $uri = null)
    {
        ...
        $newEntry = $this->insertEntry($comment, $uri, 'Zend2\GData\Photos\CommentEntry');
        return $newEntry;
    }
     ...
     * Delete a PhotoEntry.
     *
     * @param \Zend2\GData\Photos\PhotoEntry $photo The photo entry to
     *          delete.
     * @param boolean $catch Whether to catch an exception when
     *            modified and re-delete or throw
     * @return void.
     ...
     * Delete a TagEntry.
     *
     * @param \Zend2\GData\Photos\TagEntry $tag The tag entry to
     *          delete.
     * @param boolean $catch Whether to catch an exception when
     *            modified and re-delete or throw
     * @return void.
