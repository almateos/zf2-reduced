...
class EXIF extends GData
{
    ...
    /**
     * Namespaces used for Zend2_Gdata_Exif
     *
     * @var array
     */
    ...
    /**
     * Create Zend2_Gdata_Exif object
     *
    ...
    {
        $this->registerPackage('Zend2\GData\EXIF');
        $this->registerPackage('Zend2\GData\EXIF\Extension');
