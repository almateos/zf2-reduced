...
class DublinCore extends GData
{
    ...
    /**
     * Namespaces used for Zend2_Gdata_DublinCore
     *
     * @var array
     */
    ...
    /**
     * Create Zend2_Gdata_DublinCore object
     *
    ...
    {
        $this->registerPackage('Zend2\GData\DublinCore');
        $this->registerPackage('Zend2\GData\DublinCore\Extension');
