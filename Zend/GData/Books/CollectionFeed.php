 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class CollectionFeed extends \Zend2\GData\Feed
{

    /**
     * Constructor for Zend2_Gdata_Books_CollectionFeed which
     * Describes a Book Search collection feed
     *
     ...
     * @var string
     */
    protected $_entryClassName = 'Zend2\GData\Books\CollectionEntry';
