...
class Submit extends Xhtml
{
     ...
     * Constructor
     *
     * @param  string|array|\Zend2\Config\Config $spec Element name or configuration
     * @param  string|array|\Zend2\Config\Config $options Element value or configuration
     * @return void
     */
     ...
     *
     * @return \Zend2\Form\Element\Submit
     */
